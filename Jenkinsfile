...
for file in unittests/*.ut; do $file; done
 """
// Unable to convert a build step referring to "org.jenkinsci.plugins.valgrind.ValgrindBuilder". Please verify and convert manually if required.		// Shell build step
sh """
rm CMakeCache.txt
rm -rf CMakeFiles
