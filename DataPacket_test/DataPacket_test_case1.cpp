...
Test::Result DataPacket_test_case1::body()
{
    ...
    dptest1.setAlignment(1, DataPacket::BYTES);
    dptest2p->setAlignment(1, DataPacket::BYTES);
    ...
    dptest1.setAlignment(2, DataPacket::BYTES);
    dptest2p->setAlignment(2, DataPacket::BYTES);
    ...
    // afterwards
    dptest1.setAlignment(4, DataPacket::BYTES);
    dptest2p->setAlignment(4, DataPacket::BYTES);
