...
void RawDataField_test::addTestCases()
{
    ...
    ADD_TEST_CASE(SetBitsAsNumericType);
...
//==============================================================================
void RawDataField_test::Operators::addTestCases()
{
...
//==============================================================================
void RawDataField_test::GetBitsAsNumericType::addTestCases()
{
    ADD_TEST_CASE(Chunks);
    ADD_TEST_CASE(IncRangesAllSet);
    ADD_TEST_CASE(OutOfRange);
}

//==============================================================================
void RawDataField_test::SetBitsAsNumericType::addTestCases()
{
    ADD_TEST_CASE(Chunks);
    ADD_TEST_CASE(IncRanges);
}
...
//==============================================================================
Test::Result RawDataField_test::GetBit::body()
{
...
//==============================================================================
Test::Result RawDataField_test::GetBitsAsNumericType::Chunks::body()
{
...
//==============================================================================
Test::Result RawDataField_test::GetBitsAsNumericType::IncRangesAllSet::body()
{
    std::uint32_t test_uint32 = std::numeric_limits<std::uint32_t>::max();
...
Test::Result RawDataField_test::GetByte::body()
{
    ...
    RawDataField rdf(workspace, workspace_length, misc::BYTES, false);

    for (unsigned int i = 0; i < workspace_length; i++)
    {
        MUST_BE_TRUE(workspace[i] == rdf.getByte(i));
    }
...
//==============================================================================
Test::Result RawDataField_test::Operators::EqualTo::body()
{
    unsigned char workspace[workspace_length];
...
//==============================================================================
Test::Result RawDataField_test::Operators::SimpleAssignment::body()
{
...
//==============================================================================
Test::Result RawDataField_test::SetBitsAsNumericType::IncRanges::body()
{
...
//==============================================================================
Test::Result RawDataField_test::SetBitsAsNumericType::Chunks::body()
{
    std::uint32_t test_uint32 = 0;
...
Test::Result RawDataField_test::SetByte::body()
{
    ...
    memset(workspace, 1, workspace_length);
...
//==============================================================================
template<class T>
bool RawDataField_test::setBitAllBits(RawDataField& number_rdf, T& number)
{
    bool all_good = true;
...
//==============================================================================
template <class T>
bool RawDataField_test::getBitsAsNumericTypeExCaught(RawDataField& bitfield,
