...
//==============================================================================
    ...
    ArgumentProcessor::registerPositionalArgument(ParameterBase* argument)
    {
        ...
        // The idea here is to support processing additional arguments after
        // we've already processed a set of existing ones.  Probably not a very
        // likely use case but it seems nice.
...
//==============================================================================
        ...
        const std::unordered_set<std::string>& flags)
    {
             ...
             ++flag)
        {
            ...
            {
                throw std::runtime_error("Optional argument with flag \"" +
...
//==============================================================================
    void ArgumentProcessor::process(const std::string& argument)
    {
        ...
        // Have we been given a flag for an optional argument that doesn't take
        // a value?
        ...
        // By this point we know this argument must be positional.  There's no
        // other possibility.
...
//==============================================================================
    bool ArgumentProcessor::isRegistered(const ParameterBase* cv) const
    {
        ...
        for (std::unordered_map<std::string, ParameterBase*>::
        ...
        for (std::unordered_map<std::string, Parameter<unsigned int>*>::
