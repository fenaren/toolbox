...
#define DEFINE_MIXED_CONFIGURATION_VALUE_OPERATOR(OPERATOR, OP) \
    template <class T>                                          \
    bool OPERATOR(const Parameter<T>& lhs,             \
                  const T&                     rhs)             \
    {                                                           \
...
//==============================================================================
template <class T>
Parameter<T>::Parameter(const Parameter& value)
{
    *this = value;
}
...
//==============================================================================
template <class T>
void Parameter<T>::setValue(const std::string& value)
{
...
Parameter<T>::operator=(const Parameter& configuration_value)
{
...
//==============================================================================
template <class T>
Parameter<T>& Parameter<T>::operator=(const T& value)
{
    this->value = value;
    set();
...
operator<(const Parameter<T>& lhs, const Parameter<T>& rhs)
{
    T lhs_value;
    T rhs_value;
...
DEFINE_MIXED_CONFIGURATION_PARAMETER_OPERATOR(operator<, <);
...
#define INSTANTIATE_CONFIGURATION_PARAMETER_OPERATOR(OPERATOR)              \
    template bool                                                       \
...
INSTANTIATE_CONFIGURATION_PARAMETER_OPERATOR(operator<);
INSTANTIATE_CONFIGURATION_PARAMETER_OPERATOR(operator>);
INSTANTIATE_CONFIGURATION_PARAMETER_OPERATOR(operator<=);
INSTANTIATE_CONFIGURATION_PARAMETER_OPERATOR(operator>=);
INSTANTIATE_CONFIGURATION_PARAMETER_OPERATOR(operator==);
