...
namespace LinuxSocketCommon
{
  ...
  int doBlockingTimeout(int socket_fd, short events, timespec& class_ts_bt);
  ...
  // of the 'class_rfa' and 'class_rfa_size' parameters.
